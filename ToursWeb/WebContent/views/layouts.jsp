...
<body>
    ...
    <div class="">
        <c:if test="${sessionScope.url.equals('/addroom.php') }">
        <div class="bg-img">
         <jsp:include page="addroom.jsp"></jsp:include> 
         </div>
         </c:if>
        <c:if test="${sessionScope.url.equals('/reservations.php') }">
        <div class="bg-img">
        <br><br>
         <jsp:include page="reservations.jsp"></jsp:include> 
         </div>
         </c:if>
         
          <c:if test="${sessionScope.url.equals('/rooms.php') }">
       	 <div class="bg-img">
        <br><br>
         <jsp:include page="rooms.jsp"></jsp:include> 
         </div>
         </c:if>
         
            <c:if test="${sessionScope.url.equals('/updateroom.php') }">
                  <div class="bg-img">
   			<br>
             <jsp:include page="updateroom.jsp"></jsp:include>
             </div>
              </c:if>
              
             <c:if test="${sessionScope.url.equals('/newtour.php') }">
                  <div class="bg-img">
   			<br>
             <jsp:include page="newtour.jsp"></jsp:include>
             </div>
              </c:if>
            <c:if test="${sessionScope.url.equals('/tours.php') }">
                  <div class="bg-img">
   			<br>
             <jsp:include page="tours.jsp"></jsp:include>
             </div>
              </c:if>
              
          <c:if test="${sessionScope.url.equals('/updatetour.php') }">
                  <div class="bg-img">
   			<br>
             <jsp:include page="updatetour.jsp"></jsp:include>
             </div>
              </c:if>
    ...
    <div class="w3-modal-content w3-card-4 w3-animate-zoom" style="max-width:600px">
      ...
      <div class="w3-container w3-border-top w3-padding-16 w3-light-grey">
        ...
        <a class="navbar-brand" href="#">OUM<span style="color: #28a745">ACH H</span>otel </a>
  <p><a href="#" target="_blank" class="w3-hover-text-green">Copyright 2021</a></p>
